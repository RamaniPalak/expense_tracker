...
class AddExpenseHelper {
  static final List<Map<String, dynamic>> expenseCategories = [
    {"name": "Netflix", "icon": Icons.movie, "color": AppColors.catNetflix},
    {"name": "Food", "icon": Icons.fastfood, "color": AppColors.catFood},
    {
      "name": "Transport",
  ...
  static final List<Map<String, dynamic>> incomeCategories = [
    ...
    {"name": "Upwork", "icon": Icons.work, "color": AppColors.catUpwork},
    {"name": "Interest", "icon": Icons.account_balance, "color": Colors.orange},
